...
- **Unexpected choices**: Variable fonts, display fonts for headlines, condensed or extended widths, monospace as intentional accent (not as lazy "dev tool" default)
...
- **Diagonal flows**: Escape horizontal or vertical rigidity with diagonal arrangements
- **Full-bleed elements**: Use full viewport width or height for impact
