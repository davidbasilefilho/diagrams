...
- **Semantic meaning**: Success (green), error (red), warning (yellow or orange), info (blue)
...
- **Accent borders**: Add colored left or top borders to cards or sections
...
- **Labels and tags**: Small colored labels for metadata or categories
...
- **Blobs or organic shapes**: Soft colored shapes for visual interest
...
- **Do not rely on color alone**: Use icons, labels, or patterns alongside color
- **Test for color blindness**: Verify red and green combinations work for all users

### Cohesion

- **Consistent palette**: Use colors from defined palette, not arbitrary choices
- **Systematic application**: Same color meanings throughout (green always equals success)
