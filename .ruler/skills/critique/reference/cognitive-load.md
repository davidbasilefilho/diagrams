...
**Scoring**: Count the failed items. 0-1 failures equals low cognitive load (good). 2-3 equals moderate (address soon). 4+ equals high cognitive load (critical fix needed).

---

## The Working Memory Rule

**Humans can hold 4 or fewer items in working memory at once** (Miller Law revised by Cowan, 2001).
...
**Fix**: Standardize interaction patterns. Same type of action equals same type of UI.

### 7. The Multi-Task Demand

**Problem**: Interface requires processing multiple simultaneous inputs (reading plus deciding plus navigating).
