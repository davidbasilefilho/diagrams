...
**Profile**: Uses screen reader (VoiceOver or NVDA), keyboard-only navigation. May have low vision, motor impairment, or cognitive differences.
...
- Meaning conveyed by color alone (red equals error, green equals success)
...
- Are primary actions in the thumb zones (bottom half of screen)?
- Is state preserved if the user leaves and returns?
- Does it work on slow connections (3G)?
- Can forms leverage autocomplete and smart defaults?
- Are touch targets at least 44 by 44pt?
...
| ------------------------- | -------------------- | -------------------------------- |
| Landing page or marketing | Jordan, Riley, Casey | First impressions, trust, mobile |
| Dashboard or admin        | Alex, Sam            | Power users, accessibility       |
| E-commerce or checkout    | Casey, Riley, Jordan | Mobile, edge cases, clarity      |
| Onboarding flow           | Jordan, Casey        | Confusion, interruption          |
| Data-heavy or analytics   | Alex, Sam            | Efficiency, keyboard nav         |
| Form-heavy or wizard      | Jordan, Sam, Casey   | Clarity, accessibility, mobile   |
