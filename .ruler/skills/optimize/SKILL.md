...
- Critical resources first (async or defer non-critical)
- Preload critical assets
- Prefetch likely next pages
- Service worker for offline or caching
...
### React or Framework Optimization
...
- Use pagination (do not load everything)
...
**IMPORTANT**: Measure on real devices with real network conditions. Desktop Chrome with fast connection is not representative.
